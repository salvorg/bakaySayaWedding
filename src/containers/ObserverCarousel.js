                                ...
                                <div className="outer">
                                    <div className="inner">
                                        <div className="bg">
                                            ...
                                            <h3 className="section-heading">Дорогие друзья и родные! Мы с удовольствием приглашаем вас принять участие в новой главе нашей жизни и отпраздновать с нами нашу свадьбу.
                                            </h3>
